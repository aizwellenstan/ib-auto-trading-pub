...
backtestStock ="LUMO"
backtestDate = "20210324"

# Scanner
hot_stk_by_gain = ScannerSubscription(instrument='STK',
                                        locationCode='STK.US.MAJOR',
                                        scanCode='TOP_PERC_GAIN',
                                        belowPrice=cash*0.0149,
                                        abovePrice='11.57',
                                        aboveVolume='1409'  # <1407
                                        )
...
def CheckForPreOpen():
    for stock in scanner:
        try:
            ...
            hisBars=pd.read_csv (r'./backtest/'+backtestStock+backtestDate+'.csv')
        ...
        try:
            ...
            if(ask>0 and bid>0):
                ...
                if(op != sl):
                    ...
                    volMax = int(cash*0.0149/op)
                    vol = int(cash*0.0149/(op-sl))
