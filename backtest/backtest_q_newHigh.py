...
def main():
    try:
        ...
        for trade in trades:
            ...
            if (
                hisBarsD1[1].close < hisBarsD1[240].close * 1.6
            ): continue
        ...
        if riskOfRuin < minRiskOfRuin:
            ...
            maxNewHighPeriod = newHighPeriod
        print("minRiskOfRuin",minRiskOfRuin,"maxNewHighPeriod",maxNewHighPeriod)
        newHighPeriod += 1
