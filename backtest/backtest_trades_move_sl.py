...
try:
    ...
    while(trailSlMultipy <= 10000):
        ...
        totalNetLoss = 0
        a = 0
        trailSlTime = baseTime * trailSlMultipy
        for trade in trades:
            a += 1
            symbol = trade['symbol']
            ...
            for sym in tradableList:
                if(symbol == sym['symbol']):
                    ...
                    if(tpVal<20.189): tpVal=66.92#20.189
        ...
        print('maxTrailSlTime',str(maxTrailSlTime))
        trailSlMultipy += 1
