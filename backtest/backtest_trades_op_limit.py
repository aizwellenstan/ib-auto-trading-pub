    ...
    while(opLimitFloor<50):
        ...
        while(opLimitCeil>13.598 and opLimitCeil>opLimitFloor):
            ...
            for trade in trades:
                ...
                backtestTime = trade['time']
                op = trade['op']
                if(op>opLimitFloor and op < opLimitCeil): continue
                sl = trade['sl']
                # tp = trade['tp']
                tp = op+(op-sl)*tpVal
                trade['tp'] = tp
            ...
            if(total > maxProfit): # and winrate>0.067
                ...
                maxOpLimitCeil = opLimitCeil
                maxOpLimitFloor = opLimitFloor
            ...
            print('maxOpLimitFloor',str(maxOpLimitFloor),'maxOpLimitCeil',str(maxOpLimitCeil))
            opLimitCeil -= 1
        opLimitFloor += 1
