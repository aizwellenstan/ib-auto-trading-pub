...
def main():
    try:
        ...
        newHisBarsStocksD1arr = []
        for i in hisBarsStocksD1arr:
            data = i["d"]
            symbol = i["s"]
            newData = []
            for j in data:
        ...
        with open('./data/json/hisBarsStocksD1arr.json', mode='wt', encoding='utf-8') as file:
            json.dump(newHisBarsStocksD1arr, file, ensure_ascii=False, indent=2)
        ...
        for trade in trades:
            ...
            sma50D1 = sma(hisBarsD1closeArr[1:51], 50)
            sma150D1 = sma(hisBarsD1closeArr[1:151], 150)
            ...
            if bias_over:
                if (
                    ...
                    tp = normalizeFloat(op+(op-sl)*8.28,op,sl)
                else:
