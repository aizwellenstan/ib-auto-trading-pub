    ...
    while(bigBarLv<6.0):
        ...
        for trade in trades:
            ...
            if (
                bias < -biasval 
                and bias2 < -biasval
                and hisBarsQQQD1[0].open < hisBarsQQQD1[1].close * 0.982
            ):
                buy += 1
            ...
            while(k < 5):
                ...
                if(k<27/maxUsedBar):
                    ...
                    if (smallCandleRange3 > 0 and bigCandleRange3 > smallCandleRange3 * bigBarLv):
        ...
        if(total > maxProfit): # and winrate>0.067
            maxProfit = total
            maxTpVal = tpVal
            maxBigBarLv = bigBarLv
        print('maxTpVal',str(maxTpVal),'maxProfit',str(maxProfit))
        print('maxBigBarLv',str(maxBigBarLv))
        bigBarLv += 0.1
