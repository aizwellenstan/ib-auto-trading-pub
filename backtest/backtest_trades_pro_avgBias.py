    ...
    try:
        ...
        while period <= 330:
            ...
            for trade in trades:
                ...
                # smaD1 = sma(hisBarsD1closeArr[1:period+1], period)
                ...
                #         > (hisBarsD1[2].high - hisBarsD1[2].low) * 0.32
                #     and hisBarsD1[1].high - hisBarsD1[1].close
                #         > (hisBarsD1[1].high - hisBarsD1[1].low) * 0.32
                # ):  continue

                # if (
                #     hisBarsD1[3].high - hisBarsD1[3].close
                #     > (hisBarsD1[3].high - hisBarsD1[3].low) * 0.32
                ...
                # if (
                #     hisBarsD1[2].high - hisBarsD1[2].close
                #     > (hisBarsD1[2].high - hisBarsD1[2].low) * 0.26
                # ): continue

                # if (
                #     hisBarsD1[3].high - hisBarsD1[3].close
                #     > (hisBarsD1[3].high - hisBarsD1[3].low) * 0.2
                # ): continue
                ...
                #     > (hisBarsD1[3].high - hisBarsD1[3].low) * 0.2
                #     and hisBarsD1[2].high - hisBarsD1[2].close
                #         > (hisBarsD1[2].high - hisBarsD1[2].low) * 0.2
                #     and hisBarsD1[1].high - hisBarsD1[1].close
                #         > (hisBarsD1[1].high - hisBarsD1[1].low) * 0.2
                # ):  continue
