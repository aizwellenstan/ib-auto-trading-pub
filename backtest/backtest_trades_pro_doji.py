...
from modules.aiztradingview import GetProfit, GetPE
import requests
...
df = pd.read_csv (r'./csv/trades_4M.csv', index_col=0)
df.drop
...
def main():
    try:
        ...
        output = open("./pickle/pro/compressed/hisBarsStocks4MD1arr.p", "rb")
        gc.disable()
        ...
        output = open("./pickle/pro/compressed/hisBarsStocks4MM30arr.p", "rb")
        gc.disable()
        ...
        while dojiPeriod <= 240:
            ...
            for trade in trades:
                ...
                if (
                    ...
                    hisBarsD1[3].close < hisBarsD1[3].open and
                    hisBarsD1[2].close > hisBarsD1[2].open and
                    hisBarsD1[1].open > hisBarsD1[2].open and
                    hisBarsD1[1].high < hisBarsD1[2].close and
                    trend < 0
                ): continue
                ...
                if (
                    ...
                    hisBarsD1[1].close < hisBarsD1[1].open and
                    (
                        (hisBarsD1[12].high - hisBarsD1[12].close) /
                        (hisBarsD1[12].high - hisBarsD1[12].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    ...
                    hisBarsD1[1].close < hisBarsD1[1].open and
                    (
                        (hisBarsD1[20].high - hisBarsD1[20].close) /
                        (hisBarsD1[20].high - hisBarsD1[20].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[21].close > hisBarsD1[21].open and
                    hisBarsD1[1].close < hisBarsD1[1].open and
                    (
                        (hisBarsD1[21].high - hisBarsD1[21].close) /
                        (hisBarsD1[21].high - hisBarsD1[21].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    ...
                    hisBarsD1[1].close < hisBarsD1[1].open and
                    (
                        (hisBarsD1[26].high - hisBarsD1[26].close) /
                        (hisBarsD1[26].high - hisBarsD1[26].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[71].close > hisBarsD1[71].open and
                    hisBarsD1[1].close < hisBarsD1[1].open and
                    (
                        (hisBarsD1[71].high - hisBarsD1[71].close) /
                        (hisBarsD1[71].high - hisBarsD1[71].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[132].close > hisBarsD1[132].open and
                    hisBarsD1[1].close < hisBarsD1[1].open and
                    (
                        (hisBarsD1[132].high - hisBarsD1[132].close) /
                        (hisBarsD1[132].high - hisBarsD1[132].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[190].close > hisBarsD1[190].open and
                    hisBarsD1[1].close < hisBarsD1[1].open and
                    (
                        (hisBarsD1[190].high - hisBarsD1[190].close) /
                        (hisBarsD1[190].high - hisBarsD1[190].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    ...
                    hisBarsD1[2].close < hisBarsD1[2].open and
                    (
                        (hisBarsD1[6].high - hisBarsD1[6].close) /
                        (hisBarsD1[6].high - hisBarsD1[6].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    ...
                    hisBarsD1[2].close < hisBarsD1[2].open and
                    (
                        (hisBarsD1[9].high - hisBarsD1[9].close) /
                        (hisBarsD1[9].high - hisBarsD1[9].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    hisBarsD1[16].close > hisBarsD1[16].open and
                    hisBarsD1[2].close < hisBarsD1[2].open and
                    (
                        (hisBarsD1[16].high - hisBarsD1[16].close) /
                        (hisBarsD1[16].high - hisBarsD1[16].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    ...
                    hisBarsD1[2].close < hisBarsD1[2].open and
                    (
                        (hisBarsD1[22].high - hisBarsD1[22].close) /
                        (hisBarsD1[22].high - hisBarsD1[22].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[31].close > hisBarsD1[31].open and
                    hisBarsD1[2].close < hisBarsD1[2].open and
                    (
                        (hisBarsD1[31].high - hisBarsD1[31].close) /
                        (hisBarsD1[31].high - hisBarsD1[31].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[43].close > hisBarsD1[43].open and
                    hisBarsD1[2].close < hisBarsD1[2].open and
                    (
                        (hisBarsD1[43].high - hisBarsD1[43].close) /
                        (hisBarsD1[43].high - hisBarsD1[43].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[52].close > hisBarsD1[52].open and
                    hisBarsD1[2].close < hisBarsD1[2].open and
                    (
                        (hisBarsD1[52].high - hisBarsD1[52].close) /
                        (hisBarsD1[52].high - hisBarsD1[52].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[38].close > hisBarsD1[38].open and
                    hisBarsD1[3].close < hisBarsD1[3].open and
                    (
                        (hisBarsD1[38].high - hisBarsD1[38].close) /
                        (hisBarsD1[38].high - hisBarsD1[38].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[47].close > hisBarsD1[47].open and
                    hisBarsD1[3].close < hisBarsD1[3].open and
                    (
                        (hisBarsD1[47].high - hisBarsD1[47].close) /
                        (hisBarsD1[47].high - hisBarsD1[47].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[54].close > hisBarsD1[54].open and
                    hisBarsD1[3].close < hisBarsD1[3].open and
                    (
                        (hisBarsD1[54].high - hisBarsD1[54].close) /
                        (hisBarsD1[54].high - hisBarsD1[54].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[68].close > hisBarsD1[68].open and
                    hisBarsD1[3].close < hisBarsD1[3].open and
                    (
                        (hisBarsD1[68].high - hisBarsD1[68].close) /
                        (hisBarsD1[68].high - hisBarsD1[68].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[73].close > hisBarsD1[73].open and
                    hisBarsD1[3].close < hisBarsD1[3].open and
                    (
                        (hisBarsD1[73].high - hisBarsD1[73].close) /
                        (hisBarsD1[73].high - hisBarsD1[73].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    ...
                    hisBarsD1[4].close < hisBarsD1[4].open and
                    (
                        (hisBarsD1[19].high - hisBarsD1[19].close) /
                        (hisBarsD1[19].high - hisBarsD1[19].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    hisBarsD1[55].close > hisBarsD1[55].open and
                    hisBarsD1[4].close < hisBarsD1[4].open and
                    (
                        (hisBarsD1[55].high - hisBarsD1[55].close) /
                        (hisBarsD1[55].high - hisBarsD1[55].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[56].close > hisBarsD1[56].open and
                    hisBarsD1[4].close < hisBarsD1[4].open and
                    (
                        (hisBarsD1[56].high - hisBarsD1[56].close) /
                        (hisBarsD1[56].high - hisBarsD1[56].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    hisBarsD1[41].close > hisBarsD1[41].open and
                    hisBarsD1[5].close < hisBarsD1[5].open and
                    (
                        (hisBarsD1[41].high - hisBarsD1[41].close) /
                        (hisBarsD1[41].high - hisBarsD1[41].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    hisBarsD1[123].close > hisBarsD1[123].open and
                    hisBarsD1[6].close < hisBarsD1[6].open and
                    (
                        (hisBarsD1[123].high - hisBarsD1[123].close) /
                        (hisBarsD1[123].high - hisBarsD1[123].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[130].close > hisBarsD1[130].open and
                    hisBarsD1[6].close < hisBarsD1[6].open and
                    (
                        (hisBarsD1[130].high - hisBarsD1[130].close) /
                        (hisBarsD1[130].high - hisBarsD1[130].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    hisBarsD1[46].close > hisBarsD1[46].open and
                    hisBarsD1[7].close < hisBarsD1[7].open and
                    (
                        (hisBarsD1[46].high - hisBarsD1[46].close) /
                        (hisBarsD1[46].high - hisBarsD1[46].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[164].close > hisBarsD1[164].open and
                    hisBarsD1[7].close < hisBarsD1[7].open and
                    (
                        (hisBarsD1[164].high - hisBarsD1[164].close) /
                        (hisBarsD1[164].high - hisBarsD1[164].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[209].close > hisBarsD1[209].open and
                    hisBarsD1[7].close < hisBarsD1[7].open and
                    (
                        (hisBarsD1[209].high - hisBarsD1[209].close) /
                        (hisBarsD1[209].high - hisBarsD1[209].low)
                    ) > 0.55
                ): continue
                ...
                if (
                    ...
                    hisBarsD1[9].close < hisBarsD1[9].open and
                    (
                        (hisBarsD1[14].high - hisBarsD1[14].close) /
                        (hisBarsD1[14].high - hisBarsD1[14].low)
                    ) > 0.55
                ): continue
                ...
                if (
                 ...
                 if (
                    hisBarsD1[85].close > hisBarsD1[85].open and
                    hisBarsD1[11].close < hisBarsD1[11].open and
                    (
                        (hisBarsD1[85].high - hisBarsD1[85].close) /
                        (hisBarsD1[85].high - hisBarsD1[85].low)
                    ) > 0.55
                ): continue

                if (
                    hisBarsD1[dojiPeriod].close > hisBarsD1[dojiPeriod].open and
                    hisBarsD1[11].close < hisBarsD1[11].open and
                    (
                        (hisBarsD1[dojiPeriod].high - hisBarsD1[dojiPeriod].close) /
                        (hisBarsD1[dojiPeriod].high - hisBarsD1[dojiPeriod].low)
                    ) > 0.55
                ): continue

                rangeHigh = max(hisBarsD1closeArr[1:18])
                rangeLow = min(hisBarsD1closeArr[1:18])

                if (
                    (rangeHigh - rangeLow) / hisBarsD1[1].close < 0.053
                ): continue
                ...
                #     hisBarsD1[3].close < hisBarsD1[3].open and
                #     hisBarsD1[2].close < hisBarsD1[2].open and
                #     abs(hisBarsD1[5].close - hisBarsD1[5].open)
                #     < (hisBarsD1[5].high - hisBarsD1[5].low) * 0.02 and
                #     abs(hisBarsD1[1].close - hisBarsD1[1].open)
                #     < (hisBarsD1[1].high - hisBarsD1[1].low) * 0.19
                # ): continue

                # hisBarsD1closeArr = []
                # for d in hisBarsD1:
                #     hisBarsD1closeArr.append(d.close)
                # if trend(hisBarsD1closeArr[1:26]) < 0: continue
                ...
                #     hisBarsD1[2].close > hisBarsD1[2].open and
                #     hisBarsD1[1].close > hisBarsD1[1].open and
                #     hisBarsD1[5].open < hisBarsD1[6].close and
                #     hisBarsD1[1].close < hisBarsD1[4].close and
                #     hisBarsD1[1].close < hisBarsD1[3].close and
                #     hisBarsD1[1].open < hisBarsD1[4].low and
                #     hisBarsD1[1].open < hisBarsD1[3].low and
                #     hisBarsD1[1].close < hisBarsD1[2].low
                # ): 
                #     rangeHigh = max(hisBarsD1[4].high,hisBarsD1[3].high,
                #                     hisBarsD1[2].high,hisBarsD1[1].high)
                #     if hisBarsD1[0].open < rangeHigh: continue

                # if (
                #     hisBarsD1[21].close > hisBarsD1[20].open and
                #     hisBarsD1[11].close < hisBarsD1[11].open and
                #     hisBarsD1[9].close < hisBarsD1[9].open and
                #     hisBarsD1[3].open < hisBarsD1[4].low and
                #     hisBarsD1[2].high > hisBarsD1[3].high and
                #     hisBarsD1[2].close < hisBarsD1[3].open
                # ): continue
                ...
                # if (
                #     max(hisBarsD1[1].high,hisBarsD1[2].high,hisBarsD1[3].high
                #         ,hisBarsD1[4].high
                #         # ,hisBarsD1[5].high
                #     ) / hisBarsD1[1].close
                #     > max(
                #         hisBarsD1[5].high,hisBarsD1[6].high
                #         ,hisBarsD1[7].high,hisBarsD1[8].high,hisBarsD1[9].high
                #         ,hisBarsD1[10].high,hisBarsD1[11].high,hisBarsD1[12].high
                #         ,hisBarsD1[13].high
                #         # ,hisBarsD1[14].high
                #         # ,hisBarsD1[15].high,hisBarsD1[16].high,hisBarsD1[17].high
                #         # ,hisBarsD1[18].high
                #         )
                #     / hisBarsD1[2].close
                # ): continue
