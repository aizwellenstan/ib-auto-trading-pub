...
from modules.aiztradingview import GetProfit, GetPE, GetHighWR
import requests
...
def main():
    try:
        ...
        profitSymLst = GetHighWR()
        # peSymLst = GetPE()

        fee = 1.001392062 * 2
        tpVal = 1.15137614678 #2 #5 #2 #3.19148936 #2 #15.42857143 #5.7#5.7#35.2#23.5 #25.8
        maxProfit = 0
        ...
        for trade in trades:
            ...
            #     hisBarsD1[13].close < hisBarsD1[13].open and
