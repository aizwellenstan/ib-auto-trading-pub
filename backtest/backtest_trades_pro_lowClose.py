    ...
    try:
        ...
        while closePeriod <= 240:
            ...
            for trade in trades:
                ...
                if (
                    hisBarsD1[0].open > hisBarsD1[closePeriod].open
                    and hisBarsD1[0].low < hisBarsD1[closePeriod].open
                ): reverseBuy = True
                ...
                if trade['status'] != '':
                    ...
                    if reverseBuy: endTime = triggeredTime+timedelta(minutes=360)
                    for i in testhisBarsM30:
