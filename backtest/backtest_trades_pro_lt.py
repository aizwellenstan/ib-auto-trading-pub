...
df = pd.read_csv (r'./csv/trades_lt.csv', index_col=0)
df.drop
...
def main():
    try:
        ...
        hisBarsStocksD1arr = []
        output = open("./pickle/pro/compressed/hisBarsStocksLTD1arr.p", "rb")
        gc.disable()
        ...
        hisBarsStocksM30arr = []
        output = open("./pickle/pro/compressed/hisBarsStocksLTM30arr.p", "rb")
        gc.disable()
        ...
        for trade in trades:
            ...
            if hisBarsD1[0].open < df.iloc[-1]['lower_keltner']:
                continue
            ...
            period = 25
            df['20sma'] = df['close'].rolling(window=period).mean()
            ...
            df['lower_keltner'] = df['20sma'] - (df['ATR'] * 1.2)
            df['upper_keltner'] = df['20sma'] + (df['ATR'] * 1.2)
            ...
            # Topping Tails
            if not (
                hisBarsD1[0].open > hisBarsD1[4].high
                ...
                if(
                    ...
                    > (hisBarsD1[1].high - hisBarsD1[1].low) * 0.5
                    and hisBarsD1[2].high - hisBarsD1[2].close
                        > (hisBarsD1[2].high - hisBarsD1[2].low) * 0.5
                    and hisBarsD1[3].high - hisBarsD1[3].close
                        > (hisBarsD1[3].high - hisBarsD1[3].low) * 0.5
                    and hisBarsD1[4].high - hisBarsD1[4].close
                        > (hisBarsD1[4].high - hisBarsD1[4].low) * 0.5
                ):  continue

                if(
                    hisBarsD1[1].high - hisBarsD1[1].close
                    > (hisBarsD1[1].high - hisBarsD1[1].low) * 0.40
                    and hisBarsD1[2].high - hisBarsD1[2].close
                        > (hisBarsD1[2].high - hisBarsD1[2].low) * 0.40
                    and hisBarsD1[3].high - hisBarsD1[3].close
                        > (hisBarsD1[3].high - hisBarsD1[3].low) * 0.40
                    and hisBarsD1[4].high - hisBarsD1[4].close
                        > (hisBarsD1[4].high - hisBarsD1[4].low) * 0.40
                    and hisBarsD1[5].high - hisBarsD1[5].close
                        > (hisBarsD1[5].high - hisBarsD1[5].low) * 0.40
                ):  continue
            ...
            TRADE_STATUS_URL = "http://10.1.1.89:8000/api/v1/stock/trades?symbol="+symbol
            ...
            if trade['status'] != '':
                ...
                endTime = triggeredTime+timedelta(minutes=300)
                for i in testhisBarsM30:
