    ...
    try:
        ...
        while tpVal >= 0.01:
            ...
            for trade in trades:
                ...
                sl = trade['sl']
                tp = normalizeFloat(op+(op-sl)*5.7,op,sl)
                # vol = trade['vol']
                # vol = int((1000)/(op-sl))
                ...
                if(
                    hisBarsD1[1].high - hisBarsD1[1].close
                    > (hisBarsD1[1].high - hisBarsD1[1].low) * 0.4
                    and hisBarsD1[2].high - hisBarsD1[2].close
                        > (hisBarsD1[2].high - hisBarsD1[2].low) * 0.4
                    and hisBarsD1[3].high - hisBarsD1[3].close
                        > (hisBarsD1[3].high - hisBarsD1[3].low) * 0.4
                    and hisBarsD1[4].high - hisBarsD1[4].close
                        > (hisBarsD1[4].high - hisBarsD1[4].low) * 0.4
                    and hisBarsD1[5].high - hisBarsD1[5].close
                        > (hisBarsD1[5].high - hisBarsD1[5].low) * 0.4
                ):  continue
                ...
                if(
                    hisBarsD1[1].high - hisBarsD1[1].close
                    > (hisBarsD1[1].high - hisBarsD1[1].low) * tpVal
                ):  continue
                ...
                if trade['status'] != '':
                    ...
                    endTime = triggeredTime+timedelta(minutes=30)
                    for i in testhisBarsM30:
