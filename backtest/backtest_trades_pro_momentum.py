    ...
    try:
        ...
        while momentumVal <= 30:
            ...
            for trade in trades:
                ...
                if (
                    hisBarsD1[1].close < hisBarsD1[240].close * momentumVal
                ): continue
            ...
            if riskOfRuin < minRiskOfRuin:
                ...
                maxmomentumVal = momentumVal
            print("minRiskOfRuin",minRiskOfRuin,"maxmomentumVal",maxmomentumVal)
            momentumVal += 0.1
