...
from modules.aiztradingview import GetProfit,GetPE,GetProfitWithADR
import requests
    ...
    try:
        ...
        while performanceVal <= 1.48:
            ...
            for trade in trades:
                ...
                sl = normalizeFloat(op - adrRange * 0.04, 0.01, 0.01)
                ...
                if (
                    ...
                    if not highBreak:
                        if (
                            hisBarsD1[1].close < hisBarsD1[180].close * performanceVal and
                            trend < 0
                        ): continue
            ...
            if riskOfRuin < minRiskOfRuin:
                ...
                maxPerformanceVal = performanceVal
            print("maxPerformanceVal",maxPerformanceVal)
            performanceVal += 0.01
