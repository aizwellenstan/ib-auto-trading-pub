        ...
        while(pinbarval <= 1):
            ...
            for trade in trades:
                ...
                if(
                    ...
                    > (hisBarsD1[1].high - hisBarsD1[1].low) * pinbarval
                    and hisBarsD1[2].high - hisBarsD1[2].close
                        > (hisBarsD1[2].high - hisBarsD1[2].low) * pinbarval
                    and hisBarsD1[3].high - hisBarsD1[3].close
                        > (hisBarsD1[3].high - hisBarsD1[3].low) * pinbarval
                    and hisBarsD1[4].high - hisBarsD1[4].close
                        > (hisBarsD1[4].high - hisBarsD1[4].low) * pinbarval
                    and hisBarsD1[5].high - hisBarsD1[5].close
                        > (hisBarsD1[5].high - hisBarsD1[5].low) * pinbarval
                    and hisBarsD1[6].high - hisBarsD1[6].close
                        > (hisBarsD1[6].high - hisBarsD1[6].low) * pinbarval
                ):  continue
            ...
            if(total > maxProfit): # and winrate>0.067
                maxProfit = total
                maxTpVal = tpVal
                max_pinbarval = pinbarval
            print('maxTpVal',str(maxTpVal),'maxProfit',str(maxProfit))
            print('max_pinbarval',str(max_pinbarval))
            pinbarval += 0.01           
