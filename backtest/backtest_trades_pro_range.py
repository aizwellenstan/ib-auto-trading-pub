    ...
    try:
        ...
        while rangePeriod <= 240:
            ...
            for trade in trades:
                ...
                if (
                    hisBarsD1[1].close < hisBarsD1[180].close * 0.98
                ): continue
                ...
                rangeHigh = max(hisBarsD1closeArr[1:rangePeriod])
                rangeLow = min(hisBarsD1closeArr[1:rangePeriod])
