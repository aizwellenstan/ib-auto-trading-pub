...
def main():
    try:
        ...
        for trade in trades:
            ...
            # if (
            #     hisBarsD1[8].close > hisBarsD1[8+3].open and
            #     hisBarsD1[3].close > hisBarsD1[3+3].open and
            #     hisBarsD1[1].close > hisBarsD1[1+3].open
            # ): continue
            ...
            if (
                hisBarsD1[5].close > hisBarsD1[5+5].close and
                hisBarsD1[2].close > hisBarsD1[2+5].close and
                hisBarsD1[1].close < hisBarsD1[1+5].close
            ): continue
            ...
            #     hisBarsD1[4].close > hisBarsD1[4].open and
            #     hisBarsD1[3].close > hisBarsD1[3].open and
            #     hisBarsD1[2].close / hisBarsD1[2].open > 0.9978 and
            #     hisBarsD1[1].close / hisBarsD1[1].open > 0.9978
            # ): continue
