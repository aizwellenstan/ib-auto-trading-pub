    ...
    try:
        ...
        while adjVal >= 0.01:
            ...
            for trade in trades:
                ...
                #     > (hisBarsD1[1].high - hisBarsD1[1].low) * 0.48
                # ):  continue

                # max2High = max(hisBarsD1[1].high,hisBarsD1[2].high)
                # min2Low = min(hisBarsD1[1].low,hisBarsD1[2].low)
                # if(
                #     max2High - hisBarsD1[1].close
                #     > (max2High - min2Low) * adjVal
                # ):  continue

                # max3High = max(hisBarsD1[1].high,hisBarsD1[2].high,
                #     hisBarsD1[3].high)
                # min3Low = min(hisBarsD1[1].low,hisBarsD1[2].low,
                #     hisBarsD1[3].low)
                # if(
                #     max3High - hisBarsD1[1].close
                #     > (max3High - min3Low) * 0.47
                # ):  continue

                max3High = max(hisBarsD1[1].high,hisBarsD1[2].high,
                    hisBarsD1[3].high,hisBarsD1[4].high)
                min3Low = min(hisBarsD1[1].low,hisBarsD1[2].low,
                    hisBarsD1[3].low,hisBarsD1[4].high)
                if(
                    max3High - hisBarsD1[1].close
                    > (max3High - min3Low) * adjVal
                ):  continue
                ...
                if (
                    hisBarsD1[6].close < hisBarsD1[6].open
                    and hisBarsD1[5].close > hisBarsD1[5].open
                    and hisBarsD1[4].close < hisBarsD1[4].open
                    and hisBarsD1[3].close > hisBarsD1[3].open
                    and hisBarsD1[1].close < hisBarsD1[1].open
                    and hisBarsD1[2].close < hisBarsD1[3].low
                    and hisBarsD1[1].high < hisBarsD1[2].close
                ): continue
                ...
                if (
                    hisBarsD1[3].close < hisBarsD1[4].low
                    and hisBarsD1[2].close < hisBarsD1[3].low
                    and hisBarsD1[1].close < hisBarsD1[2].low
                    and hisBarsD1[4].high - hisBarsD1[4].close
                        > (hisBarsD1[4].high - hisBarsD1[4].low) * 0.95
                    and hisBarsD1[3].high - hisBarsD1[3].close
                        > (hisBarsD1[3].high - hisBarsD1[3].low) * 0.95
                    and hisBarsD1[2].high - hisBarsD1[2].close
                        > (hisBarsD1[2].high - hisBarsD1[2].low) * 0.95
                ): continue
            ...
            if (riskOfRuin < minRiskOfRuin):
                ...
                maxAdjVal = adjVal
            print("maxAdjVal",maxAdjVal,"minRiskOfRuin",minRiskOfRuin)
            adjVal -= 0.01
