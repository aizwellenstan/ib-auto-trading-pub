...
from modules.aiztradingview import GetProfit, GetPE, GetShareHolders
import requests
...
def main():
    try:
        ...
        shareHoldersVal = 66
        while shareHoldersVal <= 9007199254740991:
            profitSymLst = GetShareHolders(shareHoldersVal)
            total = 0
            net = 0
            win = 0
            loss = 0
