...
df = pd.read_csv (r'./csv/trades_rf.csv', index_col=0)
df.drop
...
def main():
    try:
        ...
        fee = 1.001392062 * 2
        tpVal = 15.42857143 #5.7#5.7#35.2#23.5 #25.8
        maxProfit = 0
        maxTpVal = 0
        maxSlVal = 0
        maxMarCapLimit = 0
        ...
        while tpVal >= 1:
            ...
            for trade in trades:
                ...
                if(
                    ...
                    or hisBarsD1[0].open > hisBarsD1[1].close * tpVal
                ):  continue

                # if (
                #     hisBarsD1[1].close - hisBarsD1[1].low
                #     > (hisBarsD1[1].high - hisBarsD1[1].low) * 0.79
                # ): continue

                # if (
                #     hisBarsD1[1].high > hisBarsD1[2].high
                #     and hisBarsD1[1].close < hisBarsD1[2].open
                # ): continue
                ...
                # if hisBarsD1[1].close > sma25D1 * 1.13:
                #     continue
                # # bias_over = False
                # if not (
                #     (
