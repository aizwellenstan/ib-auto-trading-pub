...
from modules.aiztradingview import GetProfit, GetPE, GetVolatilityM
import requests
...
def main():
    try:
        ...
        volatilityVal = 0.05
        while volatilityVal <= 2:
            profitSymLst = GetVolatilityM(volatilityVal)
            total = 0
            net = 0
            win = 0
            loss = 0
