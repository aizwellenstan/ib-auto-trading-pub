...
def Backtest(dataDict, length, valuepegDict, gyoushuDict, pegDict, junnriekiDict):
    balance = 1
    smaDict = {}
    sma4Dict = {}
    ignoreDict = {}
...
for symbol, npArr in dataDict.items():
    ...
    junnriekiDict[symbol] = (junnrieki/junnrieki2)/(junnrieki2/junnrieki3)
...
Backtest(cleanDataDict, length, valuepegDict, gyoushuDict, pegDict, junnriekiDict)
