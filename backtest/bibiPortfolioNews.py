...
def Backtest(dataDict, length, valuepegDict, gyoushuDict, pegDict, newsDict):
    balance = 1
    smaDict = {}
    sma4Dict = {}
    ignoreDict = {}
...
for symbol, npArr in dataDict.items():
    ...
    # if symbol in quarterDict:
    #     quarter = quarterDict[symbol]
    #     quarterLen = len(quarter)
    #     if quarterLen == 4:
    #         keijyouriekishinnchoku = quarter[2]
    ...
    #         #         if keijyouriekishinnchoku2q < 0.05: continue
    #         if keijyouriekishinnchoku3q != "-":
    #             if "%" not in str(keijyouriekishinnchoku3q):
    #                 print(keijyouriekishinnchoku3q)
...
Backtest(cleanDataDict, length, valuepegDict, gyoushuDict, pegDict, newsDict)
