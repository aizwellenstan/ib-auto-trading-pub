...
from modules.aiztradingview import GetProfitJP
...
try:
    ...
    if(saveStocksD1Dict):
        for trade in trades:
            ...
            hisBarsStocksD1Dict.append({symbol: hisBarsD1})

        pickle.dump(hisBarsStocksD1Dict, open("./pickle/pro/compressed/hisBarsStocksD1Dict.p", "wb"))
        print("pickle dump finished")
    else:
        hisBarsStocksD1Dict = pickle.load(open("./pickle/pro/compressed/jp/hisBarsStocks7MD1Dict.p", "rb"))
    ...
    df.to_csv('./csv/trades_7M_JP.csv')
    ...
    # #         hisBarsD1Dict.append(hisBarsD1)
    # #         print("data get")

    # #     pickle.dump(hisBarsD1Dict, open("./pickle/hisBarsD1Dict.p", "wb"))
    # #     print("pickle dump finished")
    # # else:
    # #     hisBarsD1Dict = pickle.load(open("./pickle/hisBarsD1Dict.p", "rb"))
    # #     print(hisBarsD1Dict[0][0].date)
