...
def main():
    try:
        ...
        if(saveStocksD1Dict):
            ...
            pickle.dump(hisBarsStocksD1Dict, open("./pickle/pro/compressed/hisBarsStocks8MD1Dict.p", "wb"),protocol=-1)
            print("pickle dump finished")
            print(ignoreList)
        ...
        #     pickle.dump(hisBarsStocksD1Dict, open("./pickle/pro/compressed/hisBarsStocks7MD1Dict.p", "wb"),protocol=-1)
        #     print("pickle dump finished")
        ...
        if(saveStocksH2Dict):
            ...
            pickle.dump(hisBarsStocksH2Dict, open("./pickle/pro/compressed/hisBarsStocks8MH2Dict.p", "wb"),protocol=-1)
            print("pickle dump finished")
        ...
        #     pickle.dump(hisBarsStocksH1Dict, open("./pickle/pro/compressed/hisBarsStocks7MH1Dict1.p", "wb"),protocol=-1)
        #     print("pickle dump finished")
        # else:
        ...
        #     pickle.dump(hisBarsStocksH1Dict, open("./pickle/pro/compressed/hisBarsStocks7MH1Dict.p", "wb"),protocol=-1)
        #     print("pickle dump finished")
