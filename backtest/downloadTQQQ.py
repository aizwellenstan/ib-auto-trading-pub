...
def main():
    try:
        ...
        if(saveStocksD1Dict):
            ...
            pickle.dump(hisBarsStocksD1Dict, open("./pickle/pro/compressed/hisBarsStocks7MTQQQD1Dict.p", "wb"),protocol=-1)
            print("pickle dump finished")
            print(ignoreList)
        ...
        if(saveStocksH1Dict):
            ...
            pickle.dump(hisBarsStocksH1Dict, open("./pickle/pro/compressed/hisBarsStocks7MTQQQH1Dict.p", "wb"),protocol=-1)
            print("pickle dump finished")
        else:
