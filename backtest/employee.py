...
from modules.irbank import GetZandaka, GetDividend, GetEmployee
...
def UpdateData(symbolList):
    rironkabukaDict, financialScoreDict, financialDetailDict, employeeDict, zandakaDict = {}, {}, {}, {}, {}
    ...
    return rironkabukaDict, financialScoreDict, financialDetailDict, employeeDict, zandakaDict
...
def main(update=False):
    ...
    if update:
        rironkabukaDict, financialScoreDict, financialDetailDict, employeeDict, zandakaDict = UpdateData(symbolListJP)
