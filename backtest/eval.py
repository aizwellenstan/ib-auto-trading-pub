...
def main():
    try:
        ...
        for trade in trades:
            ...
            strExcute = 'd1['+0+'].'+ohlc[0]+gs[0]+'d1['+0+'].'+ohlc[0]

            res = False
            res = eval(
                'hisBarsD1[9].close > hisBarsD1[9].open and hisBarsD1[8].close < hisBarsD1[8].open and hisBarsD1[7].close < hisBarsD1[7].open and hisBarsD1[5].close < hisBarsD1[5].open and hisBarsD1[3].close < hisBarsD1[3].open and hisBarsD1[1].close > hisBarsD1[1].open'
            )
