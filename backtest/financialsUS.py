...
from modules.aiztradingview import GetClose, GetCashJP, GetClose
...
def UpdateData(symbolList):
    ...
    return inventoryDict, netIncomeDict
...
def main(update=False):
    ...
    if update:
        inventoryDict, netIncomeDict = UpdateData(symbolListJP)
