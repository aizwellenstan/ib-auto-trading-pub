...
from modules.aiztradingview import GetStockASX
...
for symbol in symbolList:
    ...
    if (
        returns > 0 and
        sharpe > 0.0004 and profitFactor > 2.866 and
