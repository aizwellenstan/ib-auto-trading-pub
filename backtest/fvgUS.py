...
from modules.strategy.fvg import HpFvg
...
FUCK_ASIA_START = time_to_minutes("15:00")
...
def is_ny_op(time_str):
    ...
    # return time_in_minutes >= FUCK_ASIA_START and time_in_minutes < FUCK_ASIA_END
...
for symbol in symbolList:
    try:
        ...
        # df = ibc.GetDataDf(contractMGC, tf)
    except: continue
