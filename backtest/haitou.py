...
portfolioPath = f'{rootPath}/data/DividendToPriceAll.csv'
ignorePath = f'{rootPath}/data/IgnoreAll.csv'
noTradePath = f'{rootPath}/data/NoTradeAll.csv'
resPath = f'{rootPath}/data/PortfolioAll.csv'
...
# dividendList = take(len(dividendDict),dividendDict)
# print(dividendList[0:900])

# c = 0
# for symbol in dividendList[0:900]:
#     c += 1
#     try:
#         symbol = int(symbol)
#     except: continue
