...
def checkForOpen():
    ...
    for s in assetDebtList:
        ...
        earnings = vwap/price_earnings_ttm
        adr_close = adr/close
        adr_marketcap = adr/marketcap
        close_marketcap = vwap/marketcap
        assetDebtValList.append(close_marketcap)
    ...
    while idx < len(assetDebtValList):
        ...
        print("maxAttributeLimit", '{0:.10f}'.format(maxAttributeLimit))
        idx += 1
