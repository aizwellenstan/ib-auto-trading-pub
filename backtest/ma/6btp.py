...
def checkOP(npArr, i, bar, trades):
    ...
    if (
        ...
        npArr[i-bar*3+1][3] > npArr[i-bar*4][0] and
        npArr[i-bar*2+1][3] > npArr[i-bar*3][0] and
        npArr[i-bar+1][3] < npArr[i-bar*2][0] and
        npArr[i-1][3] > npArr[i-bar][0] and
        npArr[i-1][2] == lowArrAll.min() and
        npArr[i-bar+1][3] - low2 >
        (high2 - low2) * 0.5
    ):
        ...
        npArr[i-bar+1][3] > npArr[i-bar*2][0] and
        npArr[i-1][3] < npArr[i-bar][0] and
        npArr[i-1][1] == highArrAll.max() and
        high2 - npArr[i-bar+1][3] >
        (high2 - low2) * 0.5
    ):
