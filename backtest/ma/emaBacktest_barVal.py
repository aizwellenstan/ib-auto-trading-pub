...
def GetBestMA(symbol):
    ...
    barVal = 0.00001
    while barVal < 1:
        totalGain, totalLoss = backtest(npArr, barVal)
        ...
        if rr > maxRR:
            ...
            print(capital)
        barVal += 0.00001
    print(f"maxCapital {maxCapital} bestX {bestX} bestY {bestY} maxRR {maxRR} bestBarVal {bestBarVal}")
    return bestX, bestY
