...
sharpePicklePath = "./pickle/pro/compressed/mddDict.p"
output = open(sharpePicklePath, "rb")
gc.enable()
sharpeDict = pickle.load(output)
output.close()
gc.disable()
...
def main(dataDict, emptyDict, marketCapList, marketCapDict, adrList, adrDict):
    ...
    if totalGain > maxTotalGain:
        ...
        print(maxTotalGain,minPeriod,minMrketCap, minAdrLimit)
