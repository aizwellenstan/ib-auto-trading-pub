...
for symbol in symbolList:
    ...
    for i in range(0, len(oriNpArr)):
        npArr = oriNpArr[:i+2]
        signal, op, sl, tp = NoSupplyBar(npArr, tf)
    ...
    if (
        ...
        if sharpe < 0.027 and profitFactor <= 4.49: continue
