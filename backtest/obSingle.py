...
HK_END = time_to_minutes("17:30")
NY_START = time_to_minutes("22:25")
NY_END = time_to_minutes("22:31")
NY2_START = time_to_minutes("00:00")
NY2_END = time_to_minutes("01:30")
...
for symbol in symbolList:
    ...
    for i in range(0, len(oriNpArr)):
        npArr = oriNpArr[:i+2]
        signal, op, sl, tp = Ob(npArr, tf, tick_val)
