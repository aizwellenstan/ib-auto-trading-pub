...
from modules.irbank import GetZandaka, GetDividend, GetProductivity
...
def main(update=False):
    ...
    if update:
        rironkabukaDict, financialScoreDict, financialDetailDict, productivityDict, zandakaDict = UpdateData(symbolListJP)
        ...
        pickle.dump(productivityDict, open(productivityPath, "wb"))
