...
from modules.irbank import GetZandaka, GetDividend, GetQuarter
...
def UpdateData(symbolList):
    rironkabukaDict, financialScoreDict, financialDetailDict, quarterDict, zandakaDict = {}, {}, {}, {}, {}
    ...
    with ThreadPoolExecutor(max_workers=100) as executor:
        ...
        for future in as_completed(futures):
            ...
            symbol = result[0]
            quarter = result[1]
            if len(quarter) < 2: continue
            quarterDict[symbol] = quarter
    # with ThreadPoolExecutor(max_workers=100) as executor:
    ...
    return rironkabukaDict, financialScoreDict, financialDetailDict, quarterDict, zandakaDict
...
def main(update=False):
    ...
    if update:
        rironkabukaDict, financialScoreDict, financialDetailDict, quarterDict, zandakaDict = UpdateData(symbolListJP)
        ...
        pickle.dump(quarterDict, open(quarterPath, "wb"))
