...
from modules.aiztradingview import GetProfit,GetFloat,GetPE,GetADR,GetIndustry,GetSector,GetVol,GetMarketCap
import requests
...
def main():
    try:
        ...
        for key in volDict:
            if key in floatDict:
                if floatDict[key] > 0:
                    adrFloatList.append(adrDict[key]/floatDict[key])
        adrFloatList.sort()
        ...
        while idx < len(adrFloatList):
            ...
            for trade in trades:
                ...
                if adrRange/curFloat < adrFloatList[idx]: continue
            ...
            if(total > maxProfit + 1): # and winrate>0.067
                ...
                maxProfit = total
                maxTpVal = tpVal
                maxAdjVal = '{0:.10f}'.format(adrFloatList[idx])
