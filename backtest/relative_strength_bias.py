    ...
    try:
        ...
        while biasVal >= -2:
            ...
            for trade in trades:
                ...
                if adrRange > 2:
                    sl = normalizeFloat(op - adrRange * 0.1, 0.01,0.01)
                if adrRange > 4:
                    sl = normalizeFloat(op - adrRange * 0.18, 0.01,0.01)
                ...
                # ):
                #     if gapRange/adrRange > 0.85: continue

                # adr = (
                #     abs(hisBarsD1[1].close - hisBarsD1[2].open) +
                #     abs(hisBarsD1[3].close - hisBarsD1[4].open) +
                #     abs(hisBarsD1[5].close - hisBarsD1[6].open) +
                #     abs(hisBarsD1[7].close - hisBarsD1[8].open) +
                #     abs(hisBarsD1[9].close - hisBarsD1[10].open)
                # ) / 5
                ...
                # ):
                #     adr = (
                #         abs(hisBarsD1[1].close - hisBarsD1[4].open) +
                #         abs(hisBarsD1[5].close - hisBarsD1[8].open) +
                #         abs(hisBarsD1[9].close - hisBarsD1[12].open) +
                #         abs(hisBarsD1[13].close - hisBarsD1[16].open) +
                #         abs(hisBarsD1[17].close - hisBarsD1[20].open)
                #     ) / 5
                ...
                # ):
                #     adr = (
                #         abs(hisBarsD1[1].close - hisBarsD1[5].open) +
                #         abs(hisBarsD1[6].close - hisBarsD1[10].open) +
                #         abs(hisBarsD1[11].close - hisBarsD1[15].open) +
                #         abs(hisBarsD1[16].close - hisBarsD1[20].open) +
                #         abs(hisBarsD1[21].close - hisBarsD1[25].open)
                #     ) / 5
                ...
                # ):
                #     adr = (
                #         abs(hisBarsD1[1].close - hisBarsD1[7].open) +
                #         abs(hisBarsD1[8].close - hisBarsD1[14].open) +
                #         abs(hisBarsD1[15].close - hisBarsD1[21].open) +
                #         abs(hisBarsD1[22].close - hisBarsD1[28].open) +
                #         abs(hisBarsD1[29].close - hisBarsD1[35].open)
                #     ) / 5
                ...
                #     ) or
                #     hisBarsD1[1].close < hisBarsD1[1].open
                #     or hisBarsD1[1].close / hisBarsD1[1].low > 1.1180648619673
                # ):
                #     adr = (
                ...
                # if not hisBarsD1[1].close / hisBarsD1[1].low > 1.1180648619673:
                #     adr = (
                #         abs(hisBarsD1[1].close - hisBarsD1[17].open) +
                #         abs(hisBarsD1[18].close - hisBarsD1[34].open) +
                #         abs(hisBarsD1[35].close - hisBarsD1[51].open) +
                #         abs(hisBarsD1[52].close - hisBarsD1[68].open) +
                #         abs(hisBarsD1[67].close - hisBarsD1[83].open)
                #     ) / 5

                #     if gapRange/adr > 0.47: continue
                ...
                # # biasVal = 0.89
                # # if not (
                # #     hisBarsD1[7].close > sma5D1vii*biasVal and
                # #     hisBarsD1[6].close > sma5D1vi*biasVal and
                # #     hisBarsD1[5].close > sma5D1v*biasVal and
                # #     hisBarsD1[4].close > sma5D1iv*biasVal and
                # #     hisBarsD1[3].close > sma5D1iii*biasVal and
                # #     hisBarsD1[2].close > sma5D1ii*biasVal
                # # ): continue
                ...
                #     hisBarsD1[1].close / hisBarsD1[1].low > 1.1180648619673
                # ):
                #     if hisBarsD1[1].close / hisBarsD1[5].open > 1.08: continue

                # if hisBarsD1[1].close < hisBarsD1[1].open:
                #     if hisBarsD1[1].close / hisBarsD1[6].open > 1.1:  continue

                # if hisBarsD1[1].close / hisBarsD1[8].open > 1.14: continue

                # if hisBarsD1[1].close / hisBarsD1[9].open > 1.23: continue

                # if hisBarsD1[1].close / hisBarsD1[14].open > 1.2: continue
                ...
                # if not (
                #     hisBarsD1[1].open > hisBarsD1[2].close * 1.04 or
                #     (
                #         hisBarsD1[3].close > hisBarsD1[3].open and
                #         hisBarsD1[2].close > hisBarsD1[2].open and
                #         hisBarsD1[1].close > hisBarsD1[1].open
