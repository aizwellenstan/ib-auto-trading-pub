    ...
    try:
        ...
        for trade in trades:
            ...
            if (
                ...
                gapRange < vtiGapRange
            ): continue

            gapRange = hisBarsD1[1].high-hisBarsD1[0].open/(hisBarsD1[1].high-hisBarsD1[1].low)
            qqqGapRange = hisBarsQQQD1[1].high-hisBarsQQQD1[0].open/(hisBarsQQQD1[1].high-hisBarsQQQD1[1].low)
            spyGapRange = hisBarsSPYD1[1].high-hisBarsSPYD1[0].open/(hisBarsSPYD1[1].high-hisBarsSPYD1[1].low)
            vtiGapRange = hisBarsVTID1[1].high-hisBarsVTID1[0].open/(hisBarsVTID1[1].high-hisBarsVTID1[1].low)
