...
def main():
    try:
        ...
        output = open("./pickle/pro/compressed/hisBarsStocks6MD1arr.p", "rb")
        gc.disable()
        ...
        hisBarsStocksH1arr = []
        output = open("./pickle/pro/compressed/hisBarsStocks6MH1arr.p", "rb")
        gc.disable()
        ...
        while tpVal <= 4.47:
            ...
            for trade in trades:
                ...
                if not (
                    ...
                    (
                        hisBarsD1[3].close > hisBarsD1[3].open * 0.9910485933503835 and
                        hisBarsD1[2].close > hisBarsD1[2].open * 0.9917144678138942 and
                        hisBarsD1[1].close > hisBarsD1[1].open * 0.9980928162746343
                    )
                ):
                ...
                if not (
                    hisBarsD1[1].high > hisBarsD1[3].high and
                    hisBarsD1[1].low < hisBarsD1[2].low and
                ...
                if trade['status'] != '':
                    ...
                    endTime = triggeredTime+timedelta(minutes=330)
                    for i in testhisBarsH1:
