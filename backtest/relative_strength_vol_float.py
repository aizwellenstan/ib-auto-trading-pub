...
def main():
    try:
        ...
        for key in volDict:
            if key in floatDict:
                if floatDict[key] > 0:
                    volFloatList.append(volDict[key]/floatDict[key])
        volFloatList.sort()
        ...
        while idx < len(volFloatList):
            ...
            for trade in trades:
                ...
                if curVol/curFloat < volFloatList[idx]: continue
            ...
            if(total > maxProfit + 1): # and winrate>0.067
                ...
                maxProfit = total
                maxTpVal = tpVal
                maxAdjVal = '{0:.10f}'.format(volFloatList[idx])
