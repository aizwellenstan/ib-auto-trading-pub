...
for symbol, close in closeJPDict.items():
    ...
    rironkabukaCpDict[symbol] = rironkabuka/close
...
rironkabukaCpDict = dict(sorted(rironkabukaCpDict.items(), key=lambda item: item[1], reverse=True))
print(rironkabukaCpDict)

count = 0
newRironkabukaCpDict = {}
for k, v in rironkabukaCpDict.items():
    newRironkabukaCpDict[k] = v
    count += 1
    if count > 50:
        break
print(newRironkabukaCpDict)