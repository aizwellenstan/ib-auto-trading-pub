...
from modules.strategy.rsi import DynamicRsi
...
for symbol in symbolList:
    try:
        ...
        # contract = Future(conId=672387407, symbol='MYM', lastTradeDateOrContractMonth='20241220', multiplier='0.5', currency='USD', localSymbol='MYMZ4', tradingClass='MYM')
        # ib.qualifyContracts(contract)
    ...
    for i in range(0, len(oriNpArr)):
        npArr = oriNpArr[:i+2]
        signal, op, sl, tp = DynamicRsi(npArr, tf, tick_val)
