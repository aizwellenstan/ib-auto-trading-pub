...
from modules.irbank import GetZandaka, GetDividend, GetShort
...
def UpdateData(symbolList):
    rironkabukaDict, financialScoreDict, financialDetailDict, shortDict, zandakaDict = {}, {}, {}, {}, {}
    ...
    return rironkabukaDict, financialScoreDict, financialDetailDict, shortDict, zandakaDict
...
def main(update=False):
    ...
    if update:
        rironkabukaDict, financialScoreDict, financialDetailDict, shortDict, zandakaDict = UpdateData(symbolListJP)
