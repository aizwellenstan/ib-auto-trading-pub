...
from modules.strategy.vsa import VolumeImbalance, NoSupplyBar, PseudoInverseDownThrust
...
NY_START = time_to_minutes("23:30")
...
for symbol in symbolList:
    ...
    for i in range(0, len(oriNpArr)):
        npArr = oriNpArr[:i+2]
        signal, op, sl, tp = VolumeImbalance(npArr, tf)
