...
from modules.ib_option_chain import GetSPXBullPutCreaditSpread, GetSPXBullCallCreaditSpread, GetSPXCustomBullPutCreaditSpread, GetSPXBearCallCreaditSpread
...
def BacktestSpread(npArr, currency='USD', shortable=False,  basicPoint=0.01):
    ...
    combination = GetSPXBearCallCreaditSpread(5)
    # print(combination)
    ...
    message = f"customBearCallCreditSpread {bestCreaditSpread} \n"
