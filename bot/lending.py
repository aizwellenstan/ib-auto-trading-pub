...
from modules.irbank import GetZandaka, GetDividend, GetLending
...
def UpdateData(symbolList):
    rironkabukaDict, financialScoreDict, financialDetailDict, lendingDict, zandakaDict = {}, {}, {}, {}, {}
    ...
    with ThreadPoolExecutor(max_workers=100) as executor:
        ...
        for future in as_completed(futures):
            ...
            symbol = result[0]
            lending = result[1]
            if len(lending) < 2: continue
            lendingDict[symbol] = lending
    # with ThreadPoolExecutor(max_workers=100) as executor:
    ...
    return rironkabukaDict, financialScoreDict, financialDetailDict, lendingDict, zandakaDict
...
def main(update=False):
    ...
    lendingPath = f"{rootPath}/backtest/pickle/pro/compressed/lending.p"
    ...
    if update:
        rironkabukaDict, financialScoreDict, financialDetailDict, lendingDict, zandakaDict = UpdateData(symbolListJP)
        ...
        pickle.dump(lendingDict, open(lendingPath, "wb"))
