...
from modules.irbank import GetZandaka, GetDividend, GetOfficerHold
...
def UpdateData(symbolList):
    rironkabukaDict, financialScoreDict, financialDetailDict, officerHoldDict, zandakaDict = {}, {}, {}, {}, {}
    ...
    return rironkabukaDict, financialScoreDict, financialDetailDict, officerHoldDict, zandakaDict
...
def main(update=False):
    ...
    if update:
        rironkabukaDict, financialScoreDict, financialDetailDict, officerHoldDict, zandakaDict = UpdateData(symbolListJP)
