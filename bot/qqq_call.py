...
from modules.optionChain import GetQQQCall
...
def BacktestSpread(npArr, currency='USD', shortable=False,  basicPoint=0.01):
    ...
    # combination = GetQQQBullPutCreaditSpread(5)
    # combination = GetQQQBullCallCreaditSpread(5)
    qqqPrice, combination = GetQQQCall()
    print(combination)
    ...
    for comb in combination:
        ...
        spreadRange = comb['LongBE'] - qqqPrice
        capital = 0
        for i in range(
