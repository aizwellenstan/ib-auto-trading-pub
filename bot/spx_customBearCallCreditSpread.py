...
from modules.optionChain import GetSPXCustomBearCallCreaditSpread
...
def BacktestSpread(npArr, currency='USD'):
    spxPrice, combination = GetSPXCustomBearCallCreaditSpread(5)
    ...
    message = f"SPX Price {spxPrice} \n CustomBearCallCreditSpread {bestCreaditSpread} \n maxCapital{maxCapital}"
    Alert(message)
