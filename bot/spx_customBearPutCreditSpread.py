...
from modules.optionChain import GetSPXCustomBearPutCreaditSpread
...
def BacktestSpread(npArr, currency='USD', shortable=False,  basicPoint=0.01):
    ...
    spxPrice, combination = GetSPXCustomBearPutCreaditSpread(5)
    print(combination)
    ...
    message = f"SPX Price {spxPrice} \n CustomBearPutCreditSpread {bestCreaditSpread} \n maxCapital{maxCapital}"
    Alert(message)
