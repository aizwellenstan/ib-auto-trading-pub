...
from modules.optionChain import GetSPYCall
...
def BacktestSpread(npArr, currency='USD', shortable=False,  basicPoint=0.01):
    ...
    # combination = GetSPYBullPutCreaditSpread(5)
    # combination = GetSPYBullCallCreaditSpread(5)
    spyPrice, combination = GetSPYCall()
    print(combination)
    ...
    for comb in combination:
        ...
        spreadRange = comb['LongBE'] - spyPrice
        capital = 0
        for i in range(
