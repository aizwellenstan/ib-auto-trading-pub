...
# from modules.strategy.engulfing import Engulfing
# from modules.trade.futures import GetTradeTime, ExecTrade
...
#     MIN_VOL = 100
#     import pandas as pd
#     df = pd.read_csv("cfd_engulfing_jp.csv")
#     df.columns = ["i","symbol"]
...
#             signal, op, sl, tp = Engulfing(npArr, tf, tick_val=1)
...
#             closePos = False
#             if signal != 0:
#                 msg = f'Engulfing {cfdContractDict[symbol].symbol} {tf} {signal} {op} {sl} {tp}'
#                 vol = 100
...
#                     ExecTrade(ibc, signal, cfdContractDict[symbol], vol, op, sl, tp, closePos, False)
#                     Alert(msg)
#                     lastOpMap[symbol] = op
#                 else:
#                     print(msg)
