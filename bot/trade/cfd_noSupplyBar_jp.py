...
# from modules.trade.futures import GetTradeTime, ExecTrail
...
#     MIN_VOL = 100
#     import pandas as pd
#     df = pd.read_csv("cfd_noSupplyBar_jp.csv")
...
#             continue
#         if hour > 23: continue
#         if hour <= 0 and minute <= 15: continue
#         if hour >= 5 and minute >= 40: continue # 1440
#         tradeDict = {}
...
#             closePos = False
#             if signal != 0:
#                 msg = f'No Supply Bar {cfdContractDict[symbol].symbol} {tf} {signal} {op} {sl} {tp}'
