...
#     MIN_VOL = 1
#     import pandas as pd
#     df = pd.read_csv("cfd_threeBarReversal_us.csv")
...
#             else:
#                 print("THREE BAR REVERSAL CLOSE POS")
#             continue
...
#             signal, op, sl, tp = ThreeBarReversal(npArr, tf, tick_val=1)
...
#             closePos = False
#             if signal != 0:
#                 msg = f'ThreeBarReversal {cfdContractDict[symbol].symbol} {tf} {signal} {op} {sl} {tp}'
