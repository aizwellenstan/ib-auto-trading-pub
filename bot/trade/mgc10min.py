...
def main():
    ...
    contract = Future(conId=588626178, symbol='MGC', lastTradeDateOrContractMonth='20240828', multiplier='10', currency='USD', localSymbol='MGCQ4', tradingClass='MGC')
    # contract = Future(conId=600557575, symbol='MGC', lastTradeDateOrContractMonth='20241029', multiplier='10', currency='USD', localSymbol='MGCV4', tradingClass='MGC')
