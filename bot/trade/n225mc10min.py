...
#     # ib.qualifyContracts(contract)
#     contract = Future(conId=689341737, symbol='N225MC', lastTradeDateOrContractMonth='20240912', multiplier='10', currency='JPY', localSymbol='169090023', tradingClass='225MC')
#     contractCheck = Future(conId=618688988, symbol='N225M', lastTradeDateOrContractMonth='20240912', multiplier='100', currency='JPY', localSymbol='169090019', tradingClass='225M')
...
#         tradeDict = {}
#         for tf in tfs:
#             npArr = GetData(contractCheck, tf, restrict)
#             if len(npArr) < 1: continue
#             signal, op, sl, tp = ThreeBarReversal(npArr, tf, 5)
#             npArr = GetData(contract, tf, restrict)
#             if len(npArr) < 1: continue
...
#                     ExecTrade(signal, contract, vol, op, sl, tp, closePos)
#                     Alert(msg)
#                     lastOpMap[tf] = op
