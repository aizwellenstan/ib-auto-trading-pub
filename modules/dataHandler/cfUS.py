...
FOLDER = f"{rootPath}/data/us/cf/quarter"
...
cacheData = {}
def GetCF(symbol, col, da, shift=0):
    try:
        global cacheData
...
if __name__ == '__main__':
    from modules.aizfinviz import GetCFQ
    symbol = 'NVDA'
    cf = GetCFQ(symbol)
    res = SaveCF(symbol, cf)
    print(res)
    # print(cf)
    cf = GetCF(symbol, 'Capital Expenditures', '2024-06-24')
    print(cf)