...
def InsideBreak(npArr, tf, tick_val=0.25):
    if len(npArr) < 21:
    ...
    signal = 0
    if (
        npArr[2][3] > npArr[7][1] and
        npArr[4][1] < npArr[6][0] and
        npArr[3][1] < npArr[6][0] and
        npArr[5][2] > npArr[6][2] and
        npArr[3][2] > npArr[6][2] and
        npArr[6][1] < npArr[7][1] and
        npArr[9][3] < npArr[10][2]
