...
def calculate_technical_indicators(data):
    ...
    indicators = np.column_stack((rsi, cci, ema))
...
def prepare_ml_data(data):
    ...
    X = valid_data[:, 6:9]  # RSI, WT, CCI, ADX
...
def generate_last_signal(data, model):
    X = data[-1:, 6:9]  # RSI, WT, CCI, ADX for the last row
