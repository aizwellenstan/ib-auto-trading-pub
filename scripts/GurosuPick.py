...
from modules.aiztradingview import GetDividends, GetAll, GetGurosu
import pandas as pd
import os
import numpy as np

portfolioPath = "./data/Gurosu.csv"
...
# ignoreList = []
# noTradeList = []
benchmarkList = ['BRK.A','SPY','TQQQ','AAPL','MSFT','GOOG','AMZN','TSLA']
# benchmarkList = ['AAPL','MSFT','GOOG','AMZN','TSLA','UNH','V','MA','COST','BRK.A','SPY','TQQQ']
dump = False
for symbol in divs:
    if dump:
