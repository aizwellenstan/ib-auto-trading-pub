...
from modules.aiztradingview import GetPerformance, GetProfit, GetPerformanceMore, GetPerformancePrepare
...
risk = 0.00613800895 * 0.5548 * 0.675 * 0.4 #* 0.05 #0.79 #0.378 #0.06
...
def getPerformanceMoreSymList():
    ...
    performanceSymList = GetPerformancePrepare(-8)
