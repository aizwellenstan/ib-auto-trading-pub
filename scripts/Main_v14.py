...
# Scanner
def get_scanner():
    global scanner, gain_sym_list, active_sym_list, vol_sym_list
    gain_sym_list = []
    active_sym_list = []
    vol_sym_list = []
    ...
    scanner = gain_sym_list + active_sym_list + vol_sym_list
    remove_duplicate()
    print('gain',gain_sym_list)
    print('active',gain_sym_list)
...
def main():
    ...
    while(ib.sleep(1)):
        ...
        if(hour == 14 and min == 29 and sec == 0):
            update_balance()
