...
risk = 0.00613800895 * 0.34 #0.79 #0.378 #0.06
...
def get_scanner():
    ...
    hot_stk_by_gain = ScannerSubscription(instrument='STK',
                                        ...
                                        aboveVolume=139303, #621428 #316859 #6664151  # <1407
    ...
    #                                         # belowPrice=cash/5,
    #                                         abovePrice=18.97, #'0.97',
    #                                         aboveVolume=621428, #316859 #6664151  # <1407
    #                                         stockTypeFilter='CORP'
    #                                         )
