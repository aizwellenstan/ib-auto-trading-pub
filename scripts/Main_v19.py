...
def checkHisBarsD1(hisBarsD1, symbol):
    ...
    if (
        hisBarsD1[3-i].close > hisBarsD1[3-i].open
        and hisBarsD1[2-i].close < hisBarsD1[2-i].open
        and hisBarsD1[1-i].close > hisBarsD1[1-i].open
        and hisBarsD1[2-i].high > hisBarsD1[3-i].high
        and hisBarsD1[1-i].high < hisBarsD1[2-i].high
        and hisBarsD1[1-i].close < hisBarsD1[2-i].close
    ): return False

    # Topping Tails
    if(
        hisBarsD1[1-i].high - hisBarsD1[1-i].close
        > (hisBarsD1[1-i].high - hisBarsD1[1-i].low) * 0.48
    ):  return False
    ...
    if (
        hisBarsD1[1-i].close/hisBarsD1[momentumPeriod].close > avgMomentum
    ): return False
