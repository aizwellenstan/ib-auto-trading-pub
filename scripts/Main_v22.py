...
from modules.aiztradingview import GetPerformance,GetProfit,GetPerformanceMore,GetProfitWithADR,GetDR,GetREIT
...
def checkHisBarsD1(contract, shift, hisBarsD1, hisBarsD1reverse, symbol):
    ...
    # if (
    #     hisBarsD1[8-shift].close > hisBarsD1[8+3-shift].open and
    #     hisBarsD1[3-shift].close > hisBarsD1[3+3-shift].open and
    #     hisBarsD1[1-shift].close > hisBarsD1[1+3-shift].open
    # ): return False
    ...
    if (
        hisBarsD1[5-shift].close > hisBarsD1[5+5].close and
        hisBarsD1[2-shift].close > hisBarsD1[2+5].close and
        hisBarsD1[1-shift].close < hisBarsD1[1+5].close
    ): return False
...
def check_for_open():
    cost = 0
#     global stock_list
#     stock_list = [{'s': 'ZION', 'close1': 55.75, 'adr': 1.22791429}, {'s': 'X', 'close1': 26.64, 'adr': 1.39602143}, {'s': 'WBA', 'close1': 47.86, 'adr': 0.84473571}, {'s': 'UGRO', 'close1': 15.55, 'adr': 1.12932143}, {'s': 'UAA', 'close1': 23.66, 'adr': 0.65596429}, {'s': 'TROX', 'close1': 21.21, 'adr': 0.71196429}, {'s': 'SU', 'close1': 18.67, 'adr': 0.40892143}, {'s': 'SONO', 'close1': 40.61, 'adr': 1.74989286}, {'s': 'SLB', 'close1': 28.14, 'adr': 0.70320714}, {'s': 'RDN', 'close1': 23.5, 'adr': 0.51775714}, {'s': 'PFE', 'close1': 47.38, 'adr': 1.53714286}, {'s': 'ORMP', 'close1': 17.79, 'adr': 1.65711429}, {'s': 'ORI', 'close1': 26.2, 'adr': 0.40374286}, {'s': 'NUE', 'close1': 118.08, 'adr': 4.7031}, {'s': 'NEM', 'close1': 56.62, 'adr': 0.97785}, {'s': 'MS', 'close1': 103.85, 'adr': 1.72464286}, {'s': 'MPC', 'close1': 58.08, 'adr': 1.29607143}, {'s': 'MOS', 'close1': 31.75, 'adr':
# 0.94545}, {'s': 'MDT', 'close1': 133.36, 'adr': 2.13374286}, {'s': 'LYB', 'close1':
# 101.19, 'adr': 2.4503}, {'s': 'KSS', 'close1': 58.12, 'adr': 2.20375714}, {'s': 'JPM', 'close1': 161.75, 'adr': 2.44436429}, {'s': 'GPRE', 'close1': 33.64, 'adr': 1.99075714}, {'s': 'COP', 'close1': 55.13, 'adr': 1.20992857}, {'s': 'CLF', 'close1': 23.9, 'adr': 1.19812857}, {'s': 'BYRN', 'close1': 29.9, 'adr': 1.15310714}, {'s': 'ANF', 'close1': 35.68, 'adr': 1.95126429}, {'s': 'AMD', 'close1': 107.26, 'adr': 3.53999286}, {'s': 'ALL', 'close1': 136.23, 'adr': 2.04042143}, {'s': 'ERJ', 'close1': 17.61, 'adr': 0.72528571}, {'s': 'MAC', 'close1': 16.16, 'adr': 0.55030714}, {'s': 'DQ', 'close1': 52.01, 'adr': 3.68702143}]
