    ...
    try:
        ...
        if currency == 'USD':
            if (
                ...
                hisBarsVTID1[1-shift].close > hisBarsVTID1[1-shift].open and
                hisBarsDIAD1[1-shift].close > hisBarsDIAD1[1-shift].open and
                hisBarsIWMD1[1-shift].close > hisBarsIWMD1[1-shift].open and
...
def checkScanner(shift, symbol):
    ...
    try:
        ...
        if not checkHisBarsD1(shift,hisBarsD1,symbol):
            ...
            tp = hisBarsD1[1-shift].high+adr*7.74632748118
    ...
    for stock in stockList:
        try:
            ...
            if currency == 'USD':
                ...
                if preMarketChange < 1.0198412698412699: continue
    ...
    for stock in stockList:
        try:
            ...
            if currency == 'USD':
                ...
                # if (
                #     gap < qqqgapRangeHigh * 0.981 or 
                #     gap < iwmgapRangeHigh * 0.981
                # ):
                if (
